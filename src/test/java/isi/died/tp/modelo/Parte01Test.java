...
public class Parte01Test {
    ...
    public static void main(String[] args){
        ...
        Video video1 = new Video(200,49.5,"Paisaje lindo");
        Video video2 = new Video(250,7.5,"Paisaje feo");
        
        System.out.println("\nTitulo video 1: " +video1.getTitulo() + " -- Precio: " + video1.precio());
        System.out.println("\nTitulo video 2: " +video2.getTitulo() + " -- Precio: " + video2.precio());
        
        video1.liquidar();
        System.out.println("\nPrecio del video 1 despues de liquidar: " + video1.precio());
